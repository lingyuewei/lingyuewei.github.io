...
- He M, Liu K, Balakrishnan N, **Ling Y**. Likelihood Inference for Semiparametric Mixture Cure Generalized-Gamma Frailty Model [半参数混合治愈广义 Gamma脆弱性模型的似然推断]. *Communications in Statistics - Simulation and Computation*, 2026, 1–16.
